...
Nesta etapa do projeto, foi desenvolvida a versão CUDA do Jogo da Vida, denominada `jogodavida.cu`, com o objetivo de executar a evolução da sociedade de organismos vivos utilizando uma GPU.
...
3. As execuções foram feitas na GPU, garantindo compatibilidade com o ambiente de avaliação.
...
Além disso, o código foi desenvolvido com foco na portabilidade e compatibilidade com a GPU, utilizando práticas corretas de alocação, cópia de dados e sincronização.
...
Esta combinação foi executada na GPU, aproveitando ao máximo os recursos computacionais disponíveis.
